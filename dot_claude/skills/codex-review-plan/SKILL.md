...
- `/codex-review-plan` — 最新のplan fileをデフォルトモデル（gpt-5.4）でレビュー
- `/codex-review-plan /path/to/plan.md` — 指定パスのplan fileをレビュー
- `/codex-review-plan -m gpt-5.3-codex` — モデル指定してレビュー
- `/codex-review-plan -m gpt-5.3-codex /path/to/plan.md` — モデル＋パス指定
...
```bash
PLAN_FILE="<特定したパス>"
MODEL_OPT="-m gpt-5.4"  # -m指定があれば上書き
